...
function getBotResponse(input) {
    ...
    else if (input !== "hello" || input == "hi" || input !== "what is fear ?" || input !== "thanks") return "Yoda: I'm sorry, I couldn't find any information relating to your question. Please search for another word or phrase.";
}
// function getBotResponse(input) {
//   if (input == "hello") {
